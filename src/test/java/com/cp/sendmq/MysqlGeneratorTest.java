...
public class MysqlGeneratorTest {
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                // 全局配置
                new GlobalConfig()
                        .setOutputDir("F:\\work\\tcl\\temp")//输出目录
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("123")
                        .setUrl("jdbc:mysql://127.0.0.1:3306/本地?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=Asia/Shanghai&zeroDateTimeBehavior=convertToNull")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
...
//                        .setTablePrefix("t_")// 此处可以修改为您的表前缀
                        ...
                        .setInclude(new String[]{"student"}) // 需要生成的表
                ...
                new PackageConfig()
                        .setModuleName("web")
                        .setParent("com.cp.sendmq")// 自定义包路径
                        .setEntity("entity")
                        .setMapper("dao")
                        .setXml("xml")
        );
